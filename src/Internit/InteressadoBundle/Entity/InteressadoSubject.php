...
class InteressadoSubject
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="InteressadoGroup") 
     * @ORM\JoinTable(name="interessado_subject_group",
    ...
    public function addGroup(InteressadoGroup $group)
    {
    	$group->setGroup($this);
    ...
    public function removeGroup(InteressadoGroup $group)
    {
