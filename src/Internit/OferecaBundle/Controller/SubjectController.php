...
use Internit\OferecaBundle\Form\SubjectType;
use Internit\OferecaBundle\Form\GroupListType;
use Internit\OferecaBundle\Entity\OferecaSubject;
use Internit\OferecaBundle\Entity\OferecaSubjectGroup;
use Tupi\AdminBundle\Types\StatusType;

class SubjectController extends CrudController
{
    const REPOSITORY_NAME = 'InternitOferecaBundle:OferecaSubject';
    
    protected $repositoryName = self::REPOSITORY_NAME;
    
    protected $bundleName = 'InternitOferecaBundle:Subject';
    
    protected $defaultRoute = 'tupi_subjectOfereca_home';
